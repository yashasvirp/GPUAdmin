...
| | What | Where |
|---|---|---|
| **A** | Allocation policy — request/approval, fairness, preemption, budget tracking, burst handling | [`policy/ALLOCATION_POLICY.md`](policy/ALLOCATION_POLICY.md) |
...
[`policy/ALLOCATION_POLICY.md`](policy/ALLOCATION_POLICY.md).
